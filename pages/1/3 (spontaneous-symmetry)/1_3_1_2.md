...
{% comment %} {% include drawio-embed.html drawiolink='./pages/1/3%20(spontaneous-symmetry)/spont-sym-case-study-2.drawio' %} {% endcomment %}

{% include drawio-embed-svg.html drawiolink='./pages/1/3%20(spontaneous-symmetry)/spont-sym-case-study-2.drawio.svg' %}

{% include drawio-embed-SVGorXML.html drawiolink='./pages/1/3%20(spontaneous-symmetry)/spont-sym-case-study-2.drawio.svg' %}

{% include drawio-embed-SVGorXML.html drawiolink='./pages/1/3%20(spontaneous-symmetry)/spont-sym-case-study-2.drawio' %}
