...
### Each site is *required* to have a routing VRF and a firewall instance for the security zones of *both* endpoints for any connection
  - Regardless of whether there is any workload present in that specifc site/zone.
  - The overhead of pre-provisioning all security zones into every site is undesirable, and will create scalability issues if the number of sites and security zones grows significantly
