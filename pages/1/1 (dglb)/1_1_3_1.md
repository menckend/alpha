...
[![image](./dglb-conceptual-key.drawio.svg){:class="img-fluid"}](./pages/1/1%20(dglb)/dglb-conceptual-key.drawio.svg){:class="img-fluid"}{:target="_blank"}
...
[![image](./dglb-conceptual-1.drawio.svg){:class="img-fluid"}](./pages/1/1%20(dglb)/dglb-conceptual-1.drawio.svg)
</details>
