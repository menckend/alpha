...
{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/case-study-1-1a.drawio.svg' drawiozoom='1.5' %}
...
{% comment %}
{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/case-study-1-1b.drawio.svg' drawiozoom='1.5' %}
{% endcomment %}
