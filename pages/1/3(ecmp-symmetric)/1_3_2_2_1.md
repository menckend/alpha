...
{% capture details %}[![image](./framework-algo-2-a.drawio.svg){:class="img-fluid"}](./pages/1/3(ecmp-symmetric)/framework-algo-2-a.drawio.svg){:target="_blank"}{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/framework-algo-2-a.drawio.svg' drawiozoom='1.25' %}
...
{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/framework-algo-2-e.drawio.svg' drawiozoom='1.25' drawiolayers='0 1 zbqnbexNLjJlYS0uU_et-43' %}
...
- Equal cost paths
  - 3 paths (A, B, C)
  - Each path consists of seven nodes (6, with starting-node excluded)
{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/framework-algo-2-e.drawio.svg' drawiozoom='1.25' drawiolayers='0 1 AIeLE1Kv8Trab1-WMAeF-333667004' %}
{% endcapture %}{% capture summary %}
Case 2
{% endcapture %}{% include details.html %}
