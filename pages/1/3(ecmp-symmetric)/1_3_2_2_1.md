...
- Equal cost paths
  - 3 paths (A, B, C)
  - Each path consists of seven nodes (6, with starting-node excluded)
{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/framework-algo-2-e.drawio.svg' drawiozoom='1.25' drawiolayers='1 AIeLE1Kv8Trab1-WMAeF-333667004' %}
{% endcapture %}{% capture summary %}
Case 2
{% endcapture %}{% include details.html %}
...
{% capture details %}
{% include drawio-embed-addSVG.html drawiolink='./pages/1/3(ecmp-symmetric)/framework-algorithm-1-b.drawio.svg' drawiozoom='1.25' drawiolayers='0 1 zbqnbexNLjJlYS0uU_et-43' %}
{% endcapture %}
{% capture summary %}Show/hide diagram{% endcapture %}{% include details.html %}
