...
A large community attribute then, consists of three 32-bit values (expressed in decimal notation).  RFC 8195 provides guidance for the use of this attribute that can be summarized as:
